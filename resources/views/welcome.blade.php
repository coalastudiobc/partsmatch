        ...
        <div class="container">
            <div class="top-categories-wrapper">
                ...
                <div class="categories-boxes">
                    ...
                    @endif
                    <a
                        href="{{ route(auth()->check() && auth()->user()->hasRole('Administrator') ? 'admin.products.interior' : (auth()->check() ? auth()->user()->getRoleNames()->first() . '.products.interior' : 'Dealer.products.interior'), ['category' => $category->id]) }}">
