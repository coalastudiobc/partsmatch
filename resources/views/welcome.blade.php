        ...
        <div class="collection-main">
            <div class="collect-tab-btns">
                {{-- <a href="#" class="btn primary-btn filter-btn">
                    Filter
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="#272643">
                    ...
                    <div class="slick-tab ">
                        @foreach ($collections as $collection)
                            <a href="javascript:void(0)"
                                data-url="{{ route(auth()->check() && auth()->user()->hasRole('Administrator') ? 'admin.products.interior' : (auth()->check() ? auth()->user()->getRoleNames()->first() . '.products.interior' : 'Dealer.products.interior'), ['category' => $category->id]) }}"
