    ...
    <div class="grouped-data mb-3">
        ...
        <div class="custm-table-body" id="{{'outer'.$item->id}}">
            ...
            <div class="custm-table-head-box">
                <p>{{$item->product ? ($item->product->name ?  $item->product->name : "N/A"):'N/A' }}</p>
            </div>
            <div class="custm-table-head-box">
                <p>${{ $item->product ? ($item->product->price ?  $item->product->price : "N/A"):'N/A'  }}</p>
            </div>
            <div class="custm-table-head-box">
                <p>{{$item->product ? ($item->product->price ?  $item->product->created_at->format('m/d/Y') : "N/A"):'N/A'  }}</p>
            </div>
            <div class="custm-table-head-box">
