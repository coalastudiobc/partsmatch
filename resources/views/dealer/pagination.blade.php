...
<div class="pagination-wrapper">
    <div class="pagination-boxes">
        ...
        @else
        <a href="{{ $paginator->previousPageUrl() }}" class="pagination-box"><i class="fa-solid fa-angle-left"></i></a>
        @endif
        ...
        <a href="{{ $paginator->nextPageUrl() }}" class="pagination-box"><i class="fa-solid fa-angle-right"></i></a>
        @else
