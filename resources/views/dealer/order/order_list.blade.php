        ...
        <div class="test table-responsive">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <p>{{  $order ? '$' . ($order->shipment_price): 'N/A'}}</p>
                    </td>
                    {{-- <td>
                        <p>{{ $order ? '$' . ($order->total_amount): 'N/A'  }}</p>
                    </td> --}}
                    <td>
                        <p>{{ $order ? ($order->total_amount && !is_null($order->shipment_price) ? '$'.($order->total_amount  + $order->shipment_price) : 'N/A'):'N/A' }}</p>
                    </td>
                    <td>
                        <p>{{$order ?  date('d/m/Y', strtotime($order->created_at)):'N/A' }}</p>
                    </td>
                    <td>
                        ...
                        <a class="btn primary-btn" href="#">
                            Fulfilled</a>
                        @else
                        <a class="btn primary-btn" href="{{ route('Dealer.order.create.shippment', $order->id) }}">Pending</a>
                        @endif
                    </td>
                {{-- <td>
