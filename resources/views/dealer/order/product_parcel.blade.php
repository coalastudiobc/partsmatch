    ...
    <div class="product-detail-table product-list-table">
        <div class="adress-info-haeder">
            ...
            <div class="d-flex gap-3 align-items-cneter">
                ...
                <a href="{{ route('Dealer.order.shippment.rates') }}" class="btn primary-btn payment-btn disabled-shippmentPayment disabled_select">Payment</a>
                ...
                <div class="custm-table-head-box">
                    <div class="pro-status dimensionbtn">
                        <div class="dropdown" title="Add dimension of package">
                            ...
                            @endphp
                            <a href="#" class="btn primary-btn harvinder" style="font-size: 14px;padding: 12px 7px;" id="{{ $item->id }}" data-productName="{{ $item->product->name }}" data-productId="{{ $item->id }}"  data-flag="{{ $flag }}">
                                @if ($flag)
                                Edit
                                @else
