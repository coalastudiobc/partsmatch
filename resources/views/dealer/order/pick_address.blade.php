    ...
    <div class="custm-card">
        <div class="adress-info-main">
            ...
            <div class="right-btn-box">
                <a href="#" class="btn primary-btn add-address-btn" data-bs-toggle="modal" data-bs-target="#pickadress-modal"><img src="{{ asset('assets/images/add-round-icon.svg') }}" alt=""> Add </a>
            </div>
