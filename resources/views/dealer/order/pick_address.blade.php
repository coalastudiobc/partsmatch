...
@section('content')
            ...
            <div class="adress-info-main">
                <div class="adress-info-haeder">
                    <a class="back-btn" href="{{ route('Dealer.order.orderlist') }}"><i
                            class="fa-solid fa-angle-left back-btn"></i> Back to
                        orders</a>
                ...
                <div class="right-btn-box">
                    <a href="#" class="btn primary-btn add-address-btn" data-bs-toggle="modal"
                        data-bs-target="#pickadress-modal"><img src="{{ asset('assets/images/add-round-icon.svg') }}"
                            alt=""> Add </a>
                </div>
                        ...
                        <div class="form-control dropdown-toggle " type="button" id="dropdownMenuButton1"
                            ...
                            <span class="custm-drop-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="23" viewBox="0 0 24 23"
                                    fill="none">
                                    <path d="M19 9.00006L14 14.0001L9 9.00006" stroke="#151515" stroke-width="1.8"
        ...
        <div class="form-group">
            ...
            <div class="form-field">
                <input type="text" name="pin_code" class="form-control @error('pin_code') is-invalid @enderror"
                    value="{{ old('pin_code', auth()->user()->shippingAddress->post_code ?? '') }}" placeholder="PIN code">
                @error('pin_code')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
    ...
    Launch static backdrop modal
                ...
                <!-- Modal -->
                <div class="modal fade" id="pickadress-modal" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="modal-body">
                                <div class="">
                                    <form id="From_address" class="addForm" action="{{ route('Dealer.address.picking') }}"
                                        method="post" enctype="multipart/form-data">
                                        @csrf
                                        <h3 class="pick-address-head">Add Pick Address</h3>
                                        <div class="row">
                                            <h3>Personal info</h3>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-field">
                                                        ...
                                                        @enderror
                                                        <input type="hidden" name="address_type" id=""
                                                            value="Home">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="pin_code">Pin code<span
                                                            class="required-field">*</span></label>
                                                    <div class="form-field">
                                                        <input type="text" name="pin_code"
                                                            class="form-control @error('pin_code') is-invalid @enderror"
                                                            value="{{ old('pin_code', auth()->user()->shippingAddress->post_code ?? '') }}"
