        ...
        <ul>
            ...
            <li class="analyics-tabs-list">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingOne">
                            <a href="{{ route(auth()->user()->getRoleNames()->first() . '.products.index') }}" class="analyics-tabs-btns @if (Route::is('Dealer.products.*')) active @endif @if (Route::is('Manager.products.*')) active @endif ">
                                <div class="analyics-tabs-name">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                            <g opacity="0.3">
            ...
            <li class="analyics-tabs-list">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingOne">
                            <a href="{{ route('Dealer.subscription.plan') }}" class="analyics-tabs-btns @if (Route::is('Dealer.subscription.*')) active @endif ">
                                <div class="analyics-tabs-name">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                            <g opacity="0.3">
            ...
            <li class="analyics-tabs-list">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingOne">
                            <a href="{{ route('Dealer.feature.products.view') }}" class="analyics-tabs-btns @if (Route::is('Dealer.feature.products.*')) active @endif ">
                                <div class="analyics-tabs-name">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                            <g opacity="0.3">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="accordion-item new-tab-btn">
                        <h2 class="accordion-header" id="omheadingOne">
                            <button id="ordermanagemebt" class="accordion-button analyics-tabs-btns @if (Route::is('Dealer.order.*')) active @endif  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#omcollapseOne" aria-expanded="false" aria-controls="omcollapseOne">
                                <div class="analyics-tabs-name">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                            <g opacity="0.3">
