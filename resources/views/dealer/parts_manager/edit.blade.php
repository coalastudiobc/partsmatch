    ...
    <section class="section ">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="form-field">
                    <input type="file" name="editimage" class="form-control @error('image') is-invalid @enderror">
                    @error('image')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="col-md-6">
            <a href="{{ route(auth()->user()->getRoleNames()->first() . '.partsmanager.index') }}" class="btn secondary-btn full-btn mr-1">Back</a>
        </div>
        <div class="col-md-6">
            <button class="btn primary-btn full-btn mr-1" id="submit" type="submit">Submit</button>
        </div>
</div>
</form>
