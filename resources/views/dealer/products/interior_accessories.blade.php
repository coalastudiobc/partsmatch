                                                            ...
                                                            @if (auth()->user())
                                                                @if ($product->user_id !== auth()->user()->id)
                                                                    @if (in_array($product->id, authCartProducts()))
                                                                        <button class="btn secondary-btn add-cart-btn "
                                                                            id="added_btn">
                                                                            <span>added</span>
                                                                        </button>
                                                                            ...
                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                ...
                                                                                <defs>
                                                                                    <clipPath id="clip0_324_138">
                                                                                        <rect width="16.488" height="16.488"
                                                                                            fill="white"
                                                                ...
                                                                @endif
                                                            @else
                                                                <a class="btn secondary-btn add-cart-btn "
                                                                    href="{{ route('login') }}">
                                ...
                                @empty
                                    <div class="col-md-12 col-lg-12 col-xl-12">
                                        <div class="accessories-parts-box empty-category ">
                                            ...
                                            <img src="{{ asset('assets/images/no-product.svg') }}  " alt=""
                                                width="300">
