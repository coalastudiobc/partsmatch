                                                ...
                                                <div class="product-quantity-box">
                                                    ...
                                                    <div class="quantity-btn">
                                                        <a class="cartupdate minus" data-product_id="{{ $product->id }}"
                                                            ...
                                                            href="#">-</a>
                                                        <input type="text" name="quantity" class="quantity quantityvalue"
                                                            id="{{ 'quantity' . $product->id }}" value="1"
                                                            data-product_id="{{ $product->id }}"
                                                            data_quantity_id="{{ '#quantity' . $product->id }}" placeholder="">
                                                    ...
                                                    @isset($product->stocks_avaliable)
                                                        @if ($product->stocks_avaliable < 10)
                                                ...
                                                <div class="accordion" id="accordionExample">
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header">
                                                            <button class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#additional-information3"
                                                                aria-expanded="false" aria-controls="collapseTwodfd">
                                                                Field 3
                                                            </button>
                                                        </h2>
                                                        <div id="additional-information3"
                                                            class="accordion-collapse collapse"
                                                            data-bs-parent="#accordionExample">
                                                            <div class="accordion-body">
                                                                <p>{{ $product->field_3 }} </p>
