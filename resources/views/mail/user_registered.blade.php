...
<body bgcolor="#cccccc" link="#f26422" vlink="#f26422">
    ...
    <table width="750px" class="body" bgcolor="#E5E5E5" cellpadding="0" cellspacing="0"
        style="width:100%;background:#E5E5E5;margin:0;padding:0 20px;">
        <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    {{-- <h2
                                                                        style="font-family: 'Inter', sans-serif;text-align: center;">
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- <td valign="top"
                                                        style="width: 70%;font-size: 15px;font-family: 'Inter', sans-serif;font-style: italic; line-height: 21px;color: #606060;text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="84%" align="center" valign="top"
                                            ...
                                            {{-- <ul class="social-icons-list text-demo"
                                                ...
                                                <li class="social-icon" style="display:inline-block;margin-left:0;">
                                                    <a style="min-width: 35px; min-height: 35px; display: flex; justify-content: center; align-items: center; background: #FFFFFF; border-radius: 3px; color: #606060; font-size: 15px; margin-right: 10px; margin-top: 5px;text-decoration: none;"
                                                        ...
                                                        <img src="{{ asset('img/facebook.png') }}" alt="social icons" />
                                                    </a>
                                                </li>
                                                <li class="social-icon" style="display:inline-block;margin-left:0;">
                                                    <a style="min-width: 35px; min-height: 35px; display: flex; justify-content: center; align-items: center; background: #FFFFFF; border-radius: 3px; color: #606060; font-size: 15px; margin-right: 10px; margin-top: 5px;text-decoration: none;"
                                                        href="https://twitter.com">
                                                        <img src="{{ asset('img/twitter.png') }}" alt="social icons" />
                                                    </a>
                                                </li>
                                                <li class="social-icon" style="display:inline-block;margin-left:0;">
                                                    <a style="min-width: 35px; min-height: 35px; display: flex; justify-content: center; align-items: center; background: #FFFFFF; border-radius: 3px; color: #606060; font-size: 15px; margin-right: 10px; margin-top: 5px;text-decoration: none;"
                                            ...
                                            <span class="separate"
                                                style="display: block; border-top: 1px solid #e5e5e1; margin: 15px auto;"></span>

                                            <div style="padding: 5px 0;">
                                                <a href="{{ route('view', ['slug' => 'faq']) }}"
                                                    style="font-size: 12px;line-height: 24px;color: #606060; display: inline-block; text-decoration: none;margin-right: 10px;font-family: 'Inter', sans-serif;">FAQ
                                                </a>|
                                                <a href="{{ route('view', ['slug' => 'terms-conditions']) }}"
                                                    style="font-size: 12px;line-height: 24px;color: #606060; display: inline-block; text-decoration: none;margin-right: 10px;font-family: 'Inter', sans-serif;">Terms
                                                    of Service</a>|
                                                <a href="{{ route('view', ['slug' => 'privacy-policy']) }}"
                                                    style="font-size: 12px;line-height: 24px;color: #606060; display: inline-block; text-decoration: none;margin-right: 10px;font-family: 'Inter', sans-serif;">Privacy
                                                    Policy</a>
                                            </div>
                                    ...
                                    <tr>
                                        <td colspan="3" align="center"
                                            ...
                                            © {{ date('Y') }} parts match. All rights reserved</td>
                                    </tr>
                                    <tr>
                                        <td style="height: 30px;" colspan="3"></td>
                                    </tr>
