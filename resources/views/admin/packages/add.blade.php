                                        ...
                                        <div class="form-row row g-3 ">
                                            <div class="form-group  col-md-6">
                                                ...
                                                <div class="input-icon-custm tooltip-new">
                                                    <span data-toggle="tooltip" data-placement="left" title="Name of package, describe the package and what it offers.">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                @enderror
                                                <div class="input-icon-custm tooltip-new">
                                                    <span data-toggle="tooltip" data-placement="left" title="Amount that the user will be charged for purchasing the subscription package.">
                                                        <i class="fa-solid fa-question"></i>
                                                    </span>
                                                    <!-- <div class="tooltip-text">
                                                        <p>Amount that the user will be charged for purchasing the subscription package.</p>
                                                    </div> -->
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                @enderror
                                                <div class="input-icon-custm tooltip-new">
                                                    <span data-toggle="tooltip" data-placement="left" title="Total number of products available for this package.">
                                                        <i class="fa-solid fa-question"></i>
                                                    </span>
                                                    <!-- <div class="tooltip-text">
                                                        <p>Total number of products available for this package.</p>
                                                    </div> -->
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-icon-custm">
                                                    <span data-toggle="tooltip" data-placement="left" title="Provide a detailed description of the package. This description will be visible to users">
                                                        <i class="fa-solid fa-question"></i>
                                                    </span>
                                                    <!-- <div class="tooltip-text">
                                                        <p>Provide a detailed description of the package. This description will be visible to users. </p>
                                                    </div> -->
                                                </div>
                                            </div>
