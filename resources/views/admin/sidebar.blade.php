    {{-- <div class="dashboard-left-box">
        ...
        <div class="analyics-tabs">
            <div class="analyics-tabs-btns active">
                <div class="analyics-tabs-name">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                            fill="none">
                            <path d="M13.2509 8.50165L9.17383 9.86068L13.2509 11.2197L17.328 9.86068L13.2509 8.50165Z"
                                fill="white" />
                            <path d="M0 9.86068L4.07709 11.2197L8.15419 9.86068L4.07709 8.50165L0 9.86068Z"
                                fill="white" />
                            <path
                                ...
                                fill="white" />
                            <path d="M4.58594 17.4033L8.15339 16.2141V10.9351L4.58594 12.1242V17.4033Z"
                                fill="white" />
                            <path
                                d="M0 15.8468C0 16.0662 0.140354 16.2609 0.34849 16.3303L3.56746 17.4033V12.1242L0 10.9351V15.8468Z"
                                fill="white" />
                            <path d="M9.17383 16.2141L12.7413 17.4033V12.1242L9.17383 10.9351V16.2141Z"
                                fill="white" />
                            <path
                                d="M13.7617 17.4033L16.9807 16.3303C17.1888 16.2609 17.3292 16.0661 17.3292 15.8468V10.9351L13.7617 12.1242V17.4033Z"
                                fill="white" />
                            <path d="M4.58594 7.78811L8.15339 8.97726V3.6027L4.58594 2.41351V7.78811Z" fill="white" />
                    ...
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17"
                            ...
                            <g opacity="0.3" clip-path="url(#clip0_234_89)">
                                <path d="M13.6465 0.291565V3.32029H16.675L13.6465 0.291565Z" fill="black" />
                                <path
