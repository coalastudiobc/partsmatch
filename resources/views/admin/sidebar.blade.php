                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingOne">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#flush-collapseOne1" aria-expanded="false"
                                    aria-controls="flush-collapseOne">
                                    <a href="{{ route('admin.brands.listing') }}"
                                        class="analyics-tabs-btns @if (Route::is('admin.brands.*')) active @endif ">
                                        <div class="analyics-tabs-name">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                                                    viewBox="0 0 17 17" fill="none">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingOne">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#flush-collapseOne1" aria-expanded="false"
                                    aria-controls="flush-collapseOne">
                                    <a href="{{ route('admin.shippment.listing') }}"
                                        class="analyics-tabs-btns @if (Route::is('admin.brands.*')) active @endif ">
                                        <div class="analyics-tabs-name">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17"
                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        ...
                        <div class="accordion-item new-tab-btn">
                            <h2 class="accordion-header" id="omheadingOne">
                                <button id="ordermanagemebt" class="accordion-button analyics-tabs-btns @if (Route::is('admin.shippment.*')) active @endif  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#omcollapseOne" aria-expanded="false" aria-controls="omcollapseOne">
                                    <div class="analyics-tabs-name">
                                        <span>
                            ...
                            <div id="omcollapseOne" class="accordion-collapse collapse @if (Route::is('admin.shippment.*')) show @endif" aria-labelledby="omheadingOne" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <ul class="sub-list-sidebar">
                                        <li class="analyics-tabs-list @if (in_array(Route::current()->getName(), ['admin.shippment.listing','admin.shippment.rate.shipment']))  active @endif">
                                            <a href="{{ route('admin.shippment.listing') }}">
                                                <div class="analyics-tabs-name">
