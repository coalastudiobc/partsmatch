                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" name="name"
                                                        class="form-control disabled-inputs" placeholder="John Doe" disabled
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="email" name="email"
                                                        class="form-control disabled-inputs" placeholder="johndoe@gmail.com"
                                                        disabled value="{{ old('email', $authUser->email) }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="tel" name="phone_number"
                                                        class="form-control disabled-inputs"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="tel" name="password"
                                                        class="form-control disabled-inputs" placeholder="*********"
